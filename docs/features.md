...
- **MegaCity module surfaces**: Each non-central module now draws a thin module-colored extent plate above the shared road layer so module footprints are readable beneath sidewalks and buildings
